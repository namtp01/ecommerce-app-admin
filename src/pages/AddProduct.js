...
let schema = yup.object().shape({
    ...
    color: yup.array().min(1, "Choose at least one color").required('Colors are required'),
        ...
        <div>
            ...
            <div>
                <form onSubmit={formik.handleSubmit} className='d-flex gap-3 flex-column'>
                    ...
                    <select className='form-control py-3 mb-3 form-select' name="brand"
                    ...
                    <select className='form-control py-3 mb-3 form-select' name="category"
                    ...
                    <select className='form-control py-3 mb-3 form-select' name="tags"
                    ...
                    <Select mode='multiple' allowClear className='w-100' placeholder='Select Color'
                        defaultValue={color}
